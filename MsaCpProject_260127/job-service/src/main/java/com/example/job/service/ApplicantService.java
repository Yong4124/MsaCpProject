...
public class ApplicantService {
    ...
    public ApplicantDto getApplicant(Long id) {
        ...
        if (resume != null) {
            // ✅✅✅ 디버깅 로그 추가
            System.out.println("========================================");
            System.out.println("=== Resume 엔티티 정보 ===");
            System.out.println("SEQ_NO_M110: " + resume.getSeqNoM110());
            System.out.println("NAME: " + resume.getName());
            System.out.println("PHOTO_PATH: [" + resume.getPhotoPath() + "]");
            System.out.println("PHOTO_PATH is null? " + (resume.getPhotoPath() == null));
            System.out.println("========================================");
        ...
        ApplicantDto dto = ApplicantDto.from(applicant);

        // ✅✅✅ DTO 변환 후 로그
        System.out.println("=== DTO 변환 후 ===");
        System.out.println("DTO photoPath: [" + dto.getPhotoPath() + "]");
        System.out.println("DTO photoPath is null? " + (dto.getPhotoPath() == null));
        System.out.println("========================================");
